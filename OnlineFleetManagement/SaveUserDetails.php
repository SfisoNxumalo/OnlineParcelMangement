...
{	
    $pID = $_GET['id'];
		...
		{ 
			$sql = "INSERT INTO tblusers (NAME, EMAIL, CONTACT, ADDRESS, WORKS_AT, COMPANY_ADDRESS, USERNAME, PASSWORD) values('$name', '$email', '$phone', '$address', '$worksat', '$cAddress', '$username', '$Password')";		//SQL code that writes data into the database.

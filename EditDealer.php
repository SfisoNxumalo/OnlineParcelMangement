...

{
    ...
    $pID = $_GET['id'];
		...
		$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
                ...
                $sql = "SELECT * FROM tbldealer where ID = '$pID'";		
                            ...
                            echo <<<_END
                                            ...
                                            <div class="dabody">
                                                ...
                                                <div class="formContainer">
                                                    ...
                                                    <div class="title">Update Dealer</div>

                                                    <form action="UpdateDealer.php?id=$pID" method="POST">
                                                        <div class="user-details">
                                                            <div class="input-box">
                                                                <span class="f-detail">Dealer Name:</span>
                                                                <input type="text" name="dname" placeholder="Enter Dealer name" value="$DealerN" required>       
                                                            </div>

                                                            <div class="input-box">
                                                                <span class="f-detail">Dealer Address:</span>
                                                                <input type="text" name="daddress" placeholder="Enter Dealer address" value="$DealerA" required>          
                                                            </div>

                                                            <div class="input-box">
                                                                <span class="f-detail">Dealer Email:</span>
                                                                <input type="email" name="demail" placeholder="Enter Dealer email" value="$DealerE" required>          
                                                            </div>

                                                            <div class="input-box">
                                                                <span class="f-detail">Dealer contact:</span>
                                                                <input type="text" name="dcontact" placeholder="Enter Dealer contact" value="$DealerC" required>          
                                                            </div>

                                                            <div class="input-box">
                                                                <span class="f-detail">Province:</span>
                                                                <select class="input-bo" name="dprovince" size="1">
                                                                    <option value="empty">$DealerP</option>
        ...
        echo '<script>alert("Access Denied!")</script>';
                            ...
                            header( "Refresh:0; url=ViewParcel.html", true, 303);
    }
}
else
{
